  ...
  create or replace  view DEVELOPER_SANDBOX.DBT_SALESFORCE.V_ACCOUNTS_STG  as (
    

WITH source AS (
  SELECT * FROM  DEVELOPER_SANDBOX.DEMO_SALESFORCE."ACCOUNT"
),
users AS (
  SELECT * FROM  DEVELOPER_SANDBOX.DBT_SALESFORCE.V_USERS_STG
),
parent_accounts AS (
  SELECT * FROM  DEVELOPER_SANDBOX.DBT_SALESFORCE.V_ACCOUNTS_HIERARCHY
),
